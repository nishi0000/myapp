...
export const PageControl: FC<PageProps> = ({ arrayData }) => {
...
return (
    arrayData.length > 0 ? (    <SPaginationcontainer>
        {page === 0 || <SPagination onClick={onClickFirstPage}>最初に戻る</SPagination>}
        {page === 0 || <SPagination onClick={onClickBackPage}>前へ</SPagination>}
        {page === arrayData.length - 1 || <SPagination onClick={onClickNextPage}>次へ</SPagination>}
        {page === arrayData.length - 1 || <SPagination onClick={onClickLastPage}>最後に進む</SPagination>}
